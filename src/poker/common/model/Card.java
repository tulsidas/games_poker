...
/**
 * Represents a playing card from a set of cards {0..51} which map to cards
 * having a suit {0..3} <==> {CLUBS,DIAMONDS,HEARTS,SPADES} and a face value
 * {0..12} <==> {2..ACE}
 * 
 ...
 * 
 * 2c = 0 2d = 13 2h = 26 2s = 39 3c = 1 3d = 14 3h = 27 3s = 40 4c = 2 4d = 15
 * 4h = 28 4s = 41 5c = 3 5d = 16 5h = 29 5s = 42 6c = 4 6d = 17 6h = 30 6s = 43
 * 7c = 5 7d = 18 7h = 31 7s = 44 8c = 6 8d = 19 8h = 32 8s = 45 9c = 7 9d = 20
 * 9h = 33 9s = 46 Tc = 8 Td = 21 Th = 34 Ts = 47 Jc = 9 Jd = 22 Jh = 35 Js = 48
 * Qc = 10 Qd = 23 Qh = 36 Qs = 49 Kc = 11 Kd = 24 Kh = 37 Ks = 50 Ac = 12 Ad =
 * 25 Ah = 38 As = 51
 * 
 */
...
public class Card {
   ...
   // encoding
   public static Card readFrom(ByteBuffer buff) {
      return new Card(buff.get());
   }

   public static void writeTo(Card card, ByteBuffer buff) {
      buff.put((byte) card.getIndex());
   }
}