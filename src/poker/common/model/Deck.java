...
public class Deck {
   ...
   public synchronized Card extractRandomCard() {
      int pos = position + r.nextInt(NUM_CARDS - position);
      Card c = gCards[pos];
   ...
   public synchronized Card pickRandomCard() {
      return gCards[position + r.nextInt(NUM_CARDS - position)];
   }
    ...
    * has been dealt or not. If i < topCardIndex it has been dealt.
    * 
    * @param i
